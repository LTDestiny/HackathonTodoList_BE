...
async function main() {
    ...
    // Tạo người dùng mẫu
    const passwordHash = await bcryptjs_1.default.hash("123456", 12);
    ...
    const tasks = await Promise.all([
        ...
        prisma.task.create({
            data: {
                ...
                description: "Giải các bài tập từ 3.1 đến 3.15 về tích phân và ứng dụng. Chuẩn bị cho kiểm tra giữa kỳ.",
                priority: "HIGH",
                status: "IN_PROGRESS",
                deadlineAt: tomorrow,
                estimateMinutes: 180,
        ...
        prisma.task.create({
            data: {
                ...
                description: "Thiết kế và triển khai hệ thống quản lý thư viện với MySQL. Bao gồm ERD, database và queries.",
                priority: "HIGH",
                status: "INCOMPLETE",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Tạo ứng dụng Todo App sử dụng React, Redux và Material-UI",
                priority: "MEDIUM",
                status: "COMPLETED",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Ôn lại các thuật toán sắp xếp, tìm kiếm, cây nhị phân, và graph. Làm bài tập trên LeetCode.",
                priority: "HIGH",
                status: "INCOMPLETE",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Đọc và tóm tắt paper 'Deep Learning for Natural Language Processing' cho môn AI",
                priority: "MEDIUM",
                status: "INCOMPLETE",
                deadlineAt: nextWeek,
                estimateMinutes: 150,
        ...
        prisma.task.create({
            data: {
                ...
                description: "Thảo luận kế hoạch tổ chức cuộc thi Hackathon 2024. Phân công nhiệm vụ và timeline.",
                priority: "MEDIUM",
                status: "INCOMPLETE",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Chuẩn bị slides về 'Modern Web Development với React và TypeScript' cho buổi tech talk của CLB",
                priority: "HIGH",
                status: "IN_PROGRESS",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Phát triển module thanh toán online tích hợp VNPay và MoMo cho ứng dụng e-commerce",
                priority: "HIGH",
                status: "IN_PROGRESS",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Tổng kết công việc tuần này: API development, database optimization, code review",
                priority: "MEDIUM",
                status: "INCOMPLETE",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Đặt lịch và đi khám sức khỏe tại bệnh viện Đại học Y Hà Nội",
                priority: "MEDIUM",
                status: "INCOMPLETE",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Học từ vựng và ngữ pháp bài 15 trong sách Minna no Nihongo. Luyện tập hội thoại.",
                priority: "LOW",
                status: "INCOMPLETE",
                estimateMinutes: 60,
            },
        ...
        prisma.task.create({
            data: {
                ...
                description: "Tính toán học phí, tiền ăn, tiền thuê nhà và các chi phí khác. Tiết kiệm cho máy laptop mới.",
                priority: "MEDIUM",
                status: "COMPLETED",
                deadlineAt: new Date(now.getTime() - 5 * 24 * 60 * 60 * 1000),
        ...
        prisma.task.create({
            data: {
                ...
                description: "Tập luyện nhóm cơ ngực và tay sau. Bench press, dips, tricep extension.",
                priority: "LOW",
                status: "COMPLETED",
                deadlineAt: now,
        ...
        prisma.task.create({
            data: {
                ...
                description: "Đăng ký tham gia giải bóng đá tranh cúp khoa Công nghệ thông tin 2024",
                priority: "MEDIUM",
                status: "INCOMPLETE",
                deadlineAt: new Date(now.getTime() + 3 * 24 * 60 * 60 * 1000),
                estimateMinutes: 30,
        ...
        prisma.task.create({
            data: {
                ...
                description: "Họp nhóm thảo luận tiến độ dự án quản lý sinh viên. Review code và phân công task mới.",
                priority: "HIGH",
                status: "INCOMPLETE",
                deadlineAt: new Date(now.getTime() + 1 * 24 * 60 * 60 * 1000),
                estimateMinutes: 120,
